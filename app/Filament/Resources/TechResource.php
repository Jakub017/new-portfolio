...
class TechResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Technologie';

    protected static ?string $modelLabel = 'Technologia';

    protected static ?string $pluralModelLabel = 'Technologie';

    protected static ?string $slug = 'technologie';
