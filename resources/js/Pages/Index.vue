                ...
                <div class="about__info">
                    ...
                    <div class="about__links">
                        <a
                            ...
                            target="_blank"
                            class="about__link"
                            ><Github class="about__icon"
                        /></a>
                        <a
                            href="https://www.linkedin.com/in/jakub-lipinski/"
                            target="_blank"
                            class="about__link"
                            ><Linkedin class="about__icon"
                        /></a>
                    </div>
                </div>
            </div>
            ...
            <div class="projects__items">
                <div class="projects__item">
                    ...
                    <h3 class="projects__title">
                        Mediary – AI platform for health reports & diet advice
                    </h3>
                    <p class="projects__description">
                        Health platform using AI to analyze labs and lifestyle,
                        delivering personalized reports and diet plans.
                    </p>
                        ...
                        <div class="projects__stack">
                            <div class="projects__tech">
                                <svg
                                    ...
                                    class="projects__icon projects__icon--vue"
                                >
                                    <title>Vue.js</title>
                                    <path
                            ...
                            <div class="projects__tech">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="projects__icon projects__icon--laravel"
                                >
                                    <title>Laravel</title>
                                    <path
                            ...
                            <div class="projects__tech">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="projects__icon projects__icon--inertia"
                                >
                                    <title>Inertia</title>
                                    <path
                            ...
                            <div class="projects__tech">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="projects__icon projects__icon--tailwind"
                                >
                            ...
                            <div class="projects__tech">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="projects__icon projects__icon--sass"
                                >
                                    <title>Sass</title>
                                    <path
                            ...
                            <div class="projects__tech">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="projects__icon projects__icon--docker"
                                >
                                    <title>Docker</title>
                                    <path
                ...
                <div class="projects__item">
                    <div class="projects__image-wrapper">
                        ...
                        />
                        <img
                            src="../../../public/img/ciastadlafirm.png"
                            alt=""
                            class="projects__image"
                        />
                    </div>
                    <h3 class="projects__title">
                        CiastaDlaFirm – B2B cake store with orders &
                        integrations
                    </h3>
                    <p class="projects__description">
                        B2B cake shop for horeca & retail, built at
                        <span
                            class="projects__description projects__description--colored"
                            >Agencja Digitalowa</span
                        >, with discounts, recurring orders & integrations.
                    </p>
                    <div class="projects__bottom">
                        <div class="projects__stack">
                            <div class="projects__tech">
                ...
                <div class="projects__item">
                    <div class="projects__image-wrapper">
                        ...
                        />
                        <img
                            src="../../../public/img/agata-norek-institute-2.png"
                            alt=""
                            class="projects__image"
                        />
                    </div>
                    ...
                    <h3 class="projects__title">
                        Agata Norek Institute – Trauma education & art therapy
                    </h3>
                    <p class="projects__description">
                        Lucerne-based institute blending research, ARTrauma®
                        workshops, publications, and a podcast to address
                        complex trauma.
                    </p>
                    <div class="projects__bottom">
                        <div class="projects__stack">
                        ...
                        <a
                            href="https://agata-norek-institute.ch/"
                            target="_blank"
                            class="projects__link"
                            >See live <ArrowUpRight
                        /></a>
                ...
                <div class="projects__item">
                    ...
                    <h3 class="projects__title">
                        Mediary - AI powered health app
                    </h3>
                    <p class="projects__description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Inventore odit sint possimus optio eum nobis
                        architecto natus dolor.
                    </p>
                    <div class="projects__bottom">
                        <div class="projects__stack">
                            <div class="projects__tech"></div>
                            <div class="projects__tech"></div>
                            <div class="projects__tech"></div>
                        </div>
